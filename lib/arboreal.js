;(function(name, definition) {
  ...
  function Arboreal (parent, data, id) {
    var that = this;
    that.depth = parent ? parent.depth + 1 : 0;
    that.data = data || {};
    that.parent = parent || null;
    that.id = id || nodeId(parent);
    that.children = [];
  }
  ...
  Arboreal.prototype.appendChild = function (data, id) {
    var that = this;
    var child = new Arboreal(that, data, id);
  ...
  Arboreal.prototype.removeChild = function (arg) {
    var that = this;
    if (typeof arg === 'number' && that.children[arg]) {
      return that.children.splice(arg, 1).shift();
    }
